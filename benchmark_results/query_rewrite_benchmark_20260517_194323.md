...
| Context Coverage | 68.48% | 98.63% | 44.04% |
| Context Noise | 55.54% | 26.85% | -51.65% |
| Avg Context Chars | 3794.450 | 2941.800 | -22.47% |
| Avg Retrieval Seconds | 0.235 | 0.361 | 53.82% |

## Rewrite Stats

- Rewrite changed rate: 100.00%
- Avg rewrite seconds: 1.391
- Fixed misses: 9
- Regressions: 0
...
| pronoun | 9 | 66.67% | 100.00% | 24.07% | 96.30% |
...
- Rewritten query: 在 RDB 快照实现中，fork 之后如果数据被修改了怎么办？
...
- Rewritten query: epoll 相比于前两种 I/O 多路复用机制（select 和 poll）改进了什么？
- Original hit/rank: False / None
- Rewritten hit/rank: True / 1
